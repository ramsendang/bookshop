            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}">Dashbord</a>
                        </li>   
                        @endcan
                        <li class="{{ Request::is('book')? 'nav-item active' : 'nav-item'}}">
                            <a class="nav-link" href="/book">Book</a>
                        </li>
                        <li class="{{ Request::is('cd')? 'nav-item active' : 'nav-item'}}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <form action="#" method="get">
                            ...
                            <button type="submit" class="btn btn-light">
                                <i class="fa fa-shopping-cart text-dark"></i><span class="badge badge-dark">0</span>
